            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('barang.update', $barang->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <!-- Tambahkan old() -->
                        <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $barang->jumlah) }}" min="1" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="kondisi" id="kondisi" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        @if($barang->foto)
                            ...
                            <img src="{{ asset('storage/barang/' . $barang->foto) }}" alt="Foto {{ $barang->nama_barang }}" class="h-40 w-auto object-cover rounded-md border border-gray-300 mb-3">
                        @else
                        ...
                        <input type="file" name="foto" id="foto" accept="image/*" class="w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                        <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, JPEG. Maksimal 2MB. Kosongkan jika tidak ingin mengganti foto.</p>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500">{{ old('keterangan', $barang->keterangan) }}</textarea>
                        @error('keterangan') <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                    </div>

                    <div class="flex justify-end">
                        <a href="{{ route('barang.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded mr-2">Batal</a>
