                    ...
                    <form action="{{ route('anggota.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            <label for="nia" class="block text-sm font-medium text-gray-700">NIA (Nomor Induk
                                Anggota)</label>
                            <input type="text" name="nia" id="nia" value="{{ old('nia') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan') }}" required
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500"
                                    placeholder="Contoh: Anggota Biasa, Ketua, dll">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select name="tipe_anggota" id="tipe_anggota" required
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="Anggota Muda" {{ old('tipe_anggota') == 'Anggota Muda' ? 'selected' : '' }}>Anggota Muda</option>
                                    <option value="Anggota Biasa" {{ old('tipe_anggota') == 'Anggota Biasa' ? 'selected' : '' }}>Anggota Biasa</option>
                                    <option value="Anggota Luar Biasa" {{ old('tipe_anggota') == 'Anggota Luar Biasa' ? 'selected' : '' }}>Anggota Luar Biasa</option>
                                </select>
